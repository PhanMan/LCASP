...
namespace LCASP
{
    public class DatabaseQueries
    {
        ...
        public void ClearDatabase()
        {
            ...
            {
                DeleteSchool(Convert.ToInt32(kvp.Value));
            }
        }
        ...
        public ArcherData SetArcherData(ArcherData scoreData)
        {
            ...
            if(result==1)
            {
                theCmd.CommandText = "select * from archer_data where archer_id = " + scoreData.archer_id + " order by archer_data_id desc limit 1";
